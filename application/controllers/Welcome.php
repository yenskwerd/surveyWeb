...
class Welcome extends CI_Controller {
    ...
    public function ajax_qlist()
    {
        ...
        foreach ($list as $question) {
            ...
            $row[] = $question->q_desc;
            $row[] = $question->type_id;

            //add html for action
        $row[] = '<a class="btn btn-sm btn-primary" href="javascript:void(0)" title="Edit" onclick="edit_person('."'".$question->id."'".')"><i class="glyphicon glyphicon-pencil"></i> Edit</a>
            <a class="btn btn-sm btn-danger" href="javascript:void(0)" title="Delete" onclick="delete_person('."'".$question->id."'".')"><i class="glyphicon glyphicon-trash"></i> Delete</a>
            <a class="btn btn-sm btn-default" href="javascript:void(0)" title="View" onclick="view_person('."'".$question->id."'".')"><i class="glyphicon glyphicon-file"></i> View</a>';
